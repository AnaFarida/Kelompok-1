...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?= BASEURL; ?>/homeSources/js/css/animate.css">
    
    <link rel="stylesheet" href="<?= BASEURL; ?>/homeSources/js/css/owl.carousel.min.css">
    <link rel="stylesheet" href="<?= BASEURL; ?>/homeSources/js/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="<?= BASEURL; ?>/homeSources/js/css/magnific-popup.css">

    <link rel="stylesheet" href="<?= BASEURL; ?>/homeSources/js/css/aos.css">

    <link rel="stylesheet" href="<?= BASEURL; ?>/homeSources/js/css/ionicons.min.css">

    <link rel="stylesheet" href="<?= BASEURL; ?>/homeSources/js/css/bootstrap-datepicker.css">
    <link rel="stylesheet" href="<?= BASEURL; ?>/homeSources/js/css/jquery.timepicker.css">

    
    <link rel="stylesheet" href="<?= BASEURL; ?>/homeSources/js/css/flaticon.css">
    <link rel="stylesheet" href="<?= BASEURL; ?>/homeSources/js/css/icomoon.css">
    <link rel="stylesheet" href="<?= BASEURL; ?>/homeSources/js/css/style.css">
  </head>
  <body>
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item"><a href="<?= BASEURL; ?>/homeSources/rooms.php" class="nav-link">Rooms</a></li>
	          <li class="nav-item"><a href="<?= BASEURL; ?>/homeSources/restaurant.php" class="nav-link">Restaurant</a></li>
	          <li class="nav-item active"><a href="<?= BASEURL; ?>/homeSources/about.php" class="nav-link">About</a></li>
	          <li class="nav-item"><a href="<?= BASEURL; ?>/homeSources/blog.php" class="nav-link">Blog</a></li>
	          <li class="nav-item"><a href="<?= BASEURL; ?>/homeSources/contact.php" class="nav-link">Contact</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
