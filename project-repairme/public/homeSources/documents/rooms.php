...
<html lang="en">
	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="<?= BASEURL; ?>/homeSources/documents/rooms.php" class="nav-link">Rooms</a></li>
	          <li class="nav-item"><a href="<?= BASEURL; ?>/homeSources/documents/restaurant.php" class="nav-link">Restaurant</a></li>
	          <li class="nav-item"><a href="<?= BASEURL; ?>/homeSources/documents/about.php" class="nav-link">About</a></li>
	          <li class="nav-item"><a href="<?= BASEURL; ?>/homeSources/documents/blog.php" class="nav-link">Blog</a></li>
	          <li class="nav-item"><a href="<?= BASEURL; ?>/homeSources/documents/contact.php" class="nav-link">Contact</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
    <!-- END nav -->
		<div class="hero-wrap" style="background-image: url('<?= BASEURL; ?>/homeSources/images/bg_1.jpg');">
    		...
    		<div class="row no-gutters">
    			<div class="col-lg-6">
    				<div class="room-wrap d-md-flex">
    					<a href="rooms-single.html" class="img" style="background-image: url(<?= BASEURL; ?>/homeSources/images/room-1.jpg);"></a>
    			...
    			<div class="col-lg-6">
    				<div class="room-wrap d-md-flex">
    					<a href="rooms-single.html" class="img" style="background-image: url(<?= BASEURL; ?>/homeSources/images/room-5.jpg);"></a>
    					<div class="half left-arrow d-flex align-items-center">
    						<div class="text p-4 p-xl-5 text-center">
    							<p class="star mb-0"><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span></p>
    							<p class="mb-0"><span class="price mr-1">$120.00</span> <span class="per">per night</span></p>
    			...
    			<div class="col-lg-6">
    				<div class="room-wrap d-md-flex">
    					<a href="#" class="img order-md-last" style="background-image: url(<?= BASEURL; ?>/homeSources/room-2.jpg);"></a>
    			...
    			<div class="col-lg-6">
    				<div class="room-wrap d-md-flex">
    					<a href="#" class="img order-md-last" style="background-image: url(<?= BASEURL; ?>/homeSources/room-3.jpg);"></a>
    					<div class="half right-arrow d-flex align-items-center">
    						<div class="text p-4 p-xl-5 text-center">
    							<p class="star mb-0"><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span></p>
    							<p class="mb-0"><span class="price mr-1">$120.00</span> <span class="per">per night</span></p>
    			...
    			<div class="col-lg-6">
    				<div class="room-wrap d-md-flex">
    					<a href="rooms-single.html" class="img" style="background-image: url(<?= BASEURL; ?>/homeSources/room-4.jpg);"></a>
    					<div class="half left-arrow d-flex align-items-center">
    						<div class="text p-4 p-xl-5 text-center">
    							<p class="star mb-0"><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span></p>
    							<p class="mb-0"><span class="price mr-1">$120.00</span> <span class="per">per night</span></p>
    			...
    			<div class="col-lg-6">
    				<div class="room-wrap d-md-flex">
    					<a href="rooms-single.html" class="img" style="background-image: url(<?= BASEURL; ?>/homeSources/room-6.jpg);"></a>
    					<div class="half left-arrow d-flex align-items-center">
    						<div class="text p-4 p-xl-5 text-center">
    							<p class="star mb-0"><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span><span class="ion-ios-star"></span></p>
    							<p class="mb-0"><span class="price mr-1">$120.00</span> <span class="per">per night</span></p>
  ...
  <script src="<?= BASEURL; ?>/homeSources/js/js/owl.carousel.min.js"></script>
  <script src="<?= BASEURL; ?>/homeSources/js/js/jquery.magnific-popup.min.js"></script>
  <script src="<?= BASEURL; ?>/homeSources/js/js/aos.js"></script>
  <script src="<?= BASEURL; ?>/homeSources/js/js/jquery.animateNumber.min.js"></script>
  <script src="<?= BASEURL; ?>/homeSources/js/js/jquery.mb.YTPlayer.min.js"></script>
  <script src="<?= BASEURL; ?>/homeSources/js/js/bootstrap-datepicker.js"></script>
  <!-- // <script src="js/jquery.timepicker.min.js"></script> -->
  <script src="<?= BASEURL; ?>/homeSources/js/js/scrollax.min.js"></script>
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="<?= BASEURL; ?>/homeSources/js/js/google-map.js"></script>
  <script src="<?= BASEURL; ?>/homeSources/js/js/main.js"></script>
