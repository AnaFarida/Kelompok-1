        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="single-features">
                        ...
                        <div class="feature-text">
                            <div class="feature-icon">
                                <img src="<?= BASEURL; ?>/Homesource/assets/image/features/icon-1.png" alt="">
                            </div>
                ...
                <div class="col-md-4">
                    <div class="single-features">
                        <div class="features-img">
                            <img src="<?= BASEURL; ?>/Homesource/assets/image/features/feature-2.jpg" alt="">
                        </div>
                        <div class="feature-text">
                            <div class="feature-icon">
                                <img src="<?= BASEURL; ?>/Homesource/assets/image/features/icon-2.png" alt="">
                            </div>
                            <h5>Best Trainers</h5>
                            <p>Pellentesque dictum nisl in nibh dictum volutpat nec a quam. Vivamus suscipit nisl quis
                                nulla pretium, vitae ornare leo.</p>
                ...
                <div class="col-md-4">
                    <div class="single-features">
                        <div class="features-img">
                            <img src="<?= BASEURL; ?>/Homesource/assets/image/features/feature-3.jpg" alt="">
                        </div>
                        <div class="feature-text">
                            <div class="feature-icon">
                                <img src="<?= BASEURL; ?>/Homesource/assets/image/features/icon-3.png" alt="">
                            </div>
                            <h5>Diet Plans</h5>
                            <p>Pellentesque dictum nisl in nibh dictum volutpat nec a quam. Vivamus suscipit nisl quis
                                nulla pretium, vitae ornare leo.</p>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single-service">
                        <img src="<?= BASEURL; ?>/Homesource/assets/image/icon-1.png" alt="">
                        <h5>Pilates</h5>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-service c-text">
                        <img src="<?= BASEURL; ?>/Homesource/assets/image/icon-2.png" alt="">
                        <h5>Free Lifting</h5>
                        <p>Pellentesque dictum nisl in nibh dictum volutpat nec a quam. Vivamus suscipit nisl quis nulla
                            pretium.</p>
                    </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-service">
                        <img src="<?= BASEURL; ?>/Homesource/assets/image/icon-3.png" alt="">
                        <h5>Yoga</h5>
                        <p>Pellentesque dictum nisl in nibh dictum volutpat nec a quam. Vivamus suscipit nisl quis nulla
                            pretium.</p>
                    </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-service">
                        <img src="<?= BASEURL; ?>/Homesource/assets/image/icon-4.png" alt="">
                        <h5>Spinning</h5>
                        <p>Pellentesque dictum nisl in nibh dictum volutpat nec a quam. Vivamus suscipit nisl quis nulla
                            pretium.</p>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="single-trainer">
                        <div class="trainer-img">
                            <img src="<?= BASEURL; ?>/Homesource/assets/image/trainer/trainer-1.jpg" alt="">
                            <div class="img-hover">
                ...
                <div class="col-md-4">
                    <div class="single-trainer">
                        <div class="trainer-img">
                            <img src="<?= BASEURL; ?>/Homesource/assets/image/trainer/trainer-2.jpg" alt="">
                            <div class="img-hover">
                                <a href="#"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="single-trainer">
                        <div class="trainer-img">
                            <img src="<?= BASEURL; ?>/Homesource/assets/image/trainer/trainer-3.jpg" alt="">
                            <div class="img-hover">
                                <a href="#"><i class="fa fa-plus"></i></a>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="upcoming-classes">
                        ...
                        <ul class="classes-time">
                            <li><img src="<?= BASEURL; ?>/Homesource/assets/image/stopwatch.png" alt=""> Gym Fitness <span>11:00 - 12:00</span></li>
                            <li><img src="<?= BASEURL; ?>/Homesource/assets/image/stopwatch.png" alt=""> Pilates <span>12:00 - 13:00</span></li>
                            <li><img src="<?= BASEURL; ?>/Homesource/assets/image/stopwatch.png" alt=""> Spinning <span>13:00 - 14:00</span></li>
                            <li><img src="<?= BASEURL; ?>/Homesource/assets/image/stopwatch.png" alt=""> Yoga <span>14:00 - 15:00</span></li>
                            <li><img src="<?= BASEURL; ?>/Homesource/assets/image/stopwatch.png" alt=""> Gym Fitness <span>15:00 - 16:00</span></li>
                            <li><img src="<?= BASEURL; ?>/Homesource/assets/image/stopwatch.png" alt=""> Pilates <span>16:00 - 17:00</span></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                ...
                <div class="col-lg-12">
                    <div class="footer-content">
                        <div class="footer-logo">
                            <a href="#"><img src="<?= BASEURL; ?>/Homesource/assets/image/logo.png" alt=""></a>
                        </div>
                        ...
                        <div class="footer-icon-img">
                            <img src="<?= BASEURL; ?>/Homesource/assets/image/footer-icon.png" alt="">
                        </div>
                        <div class="copyright">
